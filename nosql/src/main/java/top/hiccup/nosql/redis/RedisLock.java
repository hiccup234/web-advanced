package top.hiccup.nosql.redis;//package top.hiccup.nosql.redis;
 ...
 * 
 * 2、expire()命令对lockkey设置超时时间，为的是避免死锁问题（新版Redis好像可以再setnx的时候直接指定expire时间）。
 * 
...
public class RedisLock {
    ...
    private static Logger logger = Logger.getLogger("RedisLock");
     ...
     */
    public RedisLock(RedisTemplate redisTemplate, String key, int expireTime, long timeOut) {
        this.key = key;
